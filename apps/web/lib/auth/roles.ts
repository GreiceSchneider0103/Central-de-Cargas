...
export const MENU_BY_ROLE: Record<UserProfileRole, string[]> = {
  admin: ['/', '/operacao', '/agenda', '/solicitacoes', '/cargas', '/produtos', '/relatorios', '/auditoria', '/usuarios', '/cadastros'],
  gerente_estoque: ['/', '/operacao', '/agenda', '/solicitacoes', '/cargas', '/produtos', '/relatorios', '/auditoria', '/cadastros'],
  ...
  operador_carga: ['/operacao', '/', '/agenda', '/cargas', '/relatorios', '/cadastros'],
